...
<head>
    ...
    <script src="${pageContext.request.contextPath}/static/js/fh_index.js"></script>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/fh_index.css" type="text/css" />
</head>
<body>
<a href="#" id="fh_db"></a>
        ...
        <div class="fhyx_rm_con_top">
            ...
            <div class="fhyx_rm_con_top_r">
                <div class="fhyx_rmjx_con_r_li rm_contain">
                    <a href="fh_detai1.html" target="_blank" class="fhyx_rm_con_top_rc">
                        <div class="fhyxhk_rmjx_bottom_i">
                            <img width="286" height="135" src="https://img.fhyx.com/uploads/2020/07/02/2020070211754981.jpg" >
                        </div>
                        <div class="fhyxhk_rmjx_shodow">
                            <div class="fhyxhk_rmjx_shodow_t">死亡搁浅</div>
                            <div class="fhyxhk_rmjx_shodow_e">Death Stranding Game Play</div>
                ...
                <div class="fhyx_rmjx_con_r_li rm_contain">
                    <a href="fh_detail2.html" target="_blank" class="fhyx_rm_con_top_rc">
                        <div class="fhyxhk_rmjx_bottom_i">
                            <img width="286" height="135" src="https://img.fhyx.com/uploads/2019/12/28/2019122814420783.jpg" >
                        </div>
                        <div class="fhyxhk_rmjx_shodow">
                            <div class="fhyxhk_rmjx_shodow_t">狙击手：幽灵战士2</div>
                            <div class="fhyxhk_rmjx_shodow_e">Sniper: Ghost Warrior 2</div>
                            <div class="fhyxhk_rmjx_shodow_b">
                                <span>立即购买</span>
                            </div>
                        </div>
                ...
                <div class="fhyx_rmjx_con_r_li rm_contain">
                    <a href="fh_detail3.html" target="_blank" class="fhyx_rm_con_top_rc">
                        <div class="fhyxhk_rmjx_bottom_i">
                            <img width="286" height="135" src="https://img.fhyx.com/uploads/2020/06/11/202006111402980.jpg" >
                        </div>
                        <div class="fhyxhk_rmjx_shodow">
                            <div class="fhyxhk_rmjx_shodow_t">精灵与萤火意志</div>
                            <div class="fhyxhk_rmjx_shodow_e">Ori and the Will of the Wisps</div>
                            <div class="fhyxhk_rmjx_shodow_b">
                                <span>立即购买</span>
                            </div>
                        </div>
                ...
                <div class="fhyx_rmjx_con_r_li rm_contain">
                    <a href="fh_detail4.html" target="_blank" class="fhyx_rm_con_top_rc">
                        <div class="fhyxhk_rmjx_bottom_i">
                            <img width="286" height="135" src="https://img.fhyx.com/uploads/2018/11/20/2018112034837751.jpg" >
                        </div>
                        <div class="fhyxhk_rmjx_shodow">
                            <div class="fhyxhk_rmjx_shodow_t">绝地求生大逃杀</div>
                            <div class="fhyxhk_rmjx_shodow_e">PlayerUnknown's Battlegrounds</div>
                            <div class="fhyxhk_rmjx_shodow_b">
                                <span>立即购买</span>
                            </div>
                        </div>
            ...
            <div class="fhyxhk_foot_top_right">
                <div class="fhyxhk_foot_top_er">
                    <div class="fhyxhk_foot_top_tg">
                        ...
                        <div class="tg_img"><img src="https://static.fhyx.com/images/application/pc/hk/fhyx_app.jpg" width="100" height="100"/></div>
                    </div>
